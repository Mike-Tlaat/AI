...
CREATE TABLE public.questions (
    ...
    score          integer NOT NULL DEFAULT 1,       -- درجة السؤال (لصح/غلط، اختيار، ومقالي كحد أقصى للتصحيح اليدوي)
    blank_scores   integer[],                        -- لإكمال الفراغ فقط: درجة كل فراغ على حدة، بنفس ترتيب الفراغات
    created_at     timestamptz NOT NULL DEFAULT now()
);
